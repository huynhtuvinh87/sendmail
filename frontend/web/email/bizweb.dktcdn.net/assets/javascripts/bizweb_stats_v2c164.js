(function () {
    ...
    if (!cookieData || (window.sessionStorage && !sessionStorageData)) {
        var paramBiz = "";
        if (!!Bizweb && !!Bizweb.id) {
            paramBiz = "&id=" + Bizweb.id;
        }
        var req = "https://s.bizweb.vn/visit/record.gif?p=" + encodeURIComponent(getUrlWithoutDomain(window.location.href)) + "&r=" + encodeURIComponent(document.referrer) + "&s=" + cookieValue + paramBiz;
