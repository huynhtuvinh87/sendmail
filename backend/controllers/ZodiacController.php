...
/**
 * ZodiacController implements the CRUD actions for Category model.
 */
class ZodiacController extends BackendController {
    ...
    public function actionIndex() {
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => Zodiac::find()->orderBy('created_at DESC'),
            'pagination' => [
                'defaultPageSize' => 10
            ],
        ]);
    ...
    protected function findModel($id) {
        if (($model = Zodiac::findOne($id)) !== null) {
            return $model;
        } else {
